...
<ul class="nav nav-tabs" role="tablist">
  ...
  <li class="{$active_3|escape:'htmlall':'UTF-8'}">
    <a href="#template_3" role="tab" data-toggle="tab">
      {l s='Consent log' mod='artcokiechoicespro'}
    </a>
  </li>
  <li class="{$active_4|escape:'htmlall':'UTF-8'}">
    <a href="#template_4" role="tab" data-toggle="tab">
...
<div class="tab-content">
  ...
  <div class="tab-pane {$active_4|escape:'htmlall':'UTF-8'}" id="template_4">

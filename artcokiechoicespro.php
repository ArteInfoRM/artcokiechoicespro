            ...
            'form' => array(
                'input' => array(
                    ...
                    array(
                        ...
                        'options' => array(
                            'query' => array (
                                array('id' => '0', 'name' => $this->l("Select")),
                                array('id' => '1', 'name' => $this->l("displayFooterBefore")),
                                array('id' => '2', 'name' => $this->l("displayFooter")),
                                array('id' => '3', 'name' => $this->l("displayFooterAfter")),
                                array('id' => '4', 'name' => $this->l("CookiesDisable"))
                            ),
                            'id' => 'id',
                            'name' => 'name'
                        )
